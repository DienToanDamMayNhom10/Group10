...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link href="css/show_img.css" rel="stylesheet"
		type="text/css">
		<script type="text/javascript"
			src="js/jquery-1.7.2.min.js.download"></script>
		...
		<link rel="shortcut icon" type="image/png"
			...
			<link href="css/lightbox.css" rel="stylesheet"
				...
				<link href="css/WebResource(2).axd" type="text/css"	rel="stylesheet" class="Telerik_stylesheet">
				<link href="css/WebResource(4).axd" type="text/css"	rel="stylesheet" class="Telerik_stylesheet">
</head>
									...
									<div id="pageFooter">
										<td colspan="2"><div id="pnBottom">
												<div id="pnBottomDisplay"
													style="clear: both; background: url(/resourcess/image/bgfooter_phong.png) repeat-x; width: 1000px; height: 110px;">
													<div
